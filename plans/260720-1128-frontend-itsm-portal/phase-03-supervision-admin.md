...
- Dashboard : carte � SLA en retard � (overdue), r�solution moyenne � � � si aucune r�solution sur la p�riode, SLA masqu� pour les tickets clos dans la liste.
- Admin : formulaire d�partements (algorithme, auto-assignation, charge max), cat�gories multi-r�les, pause/absence utilisateur avec badge d'�tat.
- Contrats OpenAPI r�g�n�r�s et types frontend synchronis�s.
- Workload : colonnes � En retard � et � Disponibilit� � par agent, r�sum� bsentAgentsCount, carte � Agents en pause/absence � au Dashboard.
