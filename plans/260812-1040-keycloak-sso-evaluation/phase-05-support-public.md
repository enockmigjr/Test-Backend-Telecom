...
- MAJ : satisfaction compl�te livr�e (lien sign� 14 j one-time, page publique /satisfaction, stats dashboard, v�rifi� live).
- RESTE (5c) : envoi automatique du lien par email � la cl�ture � n�cessite un arbitrage sur le m�canisme (outbox external-delivery avec URL dans l'email, ou email direct via BullMQ). Le lien est g�n�rable manuellement (admin/superviseur) d�s maintenant.
