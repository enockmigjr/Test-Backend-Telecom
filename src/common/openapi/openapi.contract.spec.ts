...
describe('contrat openapi.json', () => {
  ...
  /** Test : contient les 136 opérations actuelles avec des operationId uniques */

  it('contient les 136 opérations actuelles avec des operationId uniques', () => {
    const operationIds = apiOperations.map((operation) => operation['operationId']);
    expect(apiOperations).toHaveLength(136);
