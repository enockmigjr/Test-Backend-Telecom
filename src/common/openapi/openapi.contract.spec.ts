...
describe('contrat openapi.json', () => {
  ...
  /** Test : contient les 138 opérations actuelles avec des operationId uniques */

  it('contient les 138 opérations actuelles avec des operationId uniques', () => {
    const operationIds = apiOperations.map((operation) => operation['operationId']);
    expect(apiOperations).toHaveLength(138);
