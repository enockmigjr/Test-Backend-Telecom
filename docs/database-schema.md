...
| Groupe | Tables |
| --- | --- |
| Noyau (15) | departments, users, categories, tickets, ticket_assignments, ticket_comments, ticket_internal_notes, ticket_history, attachments, notifications, sla_policies, audit_logs, refresh_tokens, reports, settings |
