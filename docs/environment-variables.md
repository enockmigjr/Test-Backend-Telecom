...
| Variable              | Obligatoire | Défaut   | Description                        |
| --------------------- | ----------- | -------- | ---------------------------------- |
| `JWT_ACCESS_SECRET`   | ✅          | *(à changer)* | Secret pour les access tokens |
| `JWT_REFRESH_SECRET`  | ✅          | *(à changer)* | Secret pour les refresh tokens |
...
| Variable                    | Défaut           | Description                    |
| --------------------------- | ---------------- | ------------------------------ |
| `REPORT_DOWNLOAD_SECRET`    | *(à changer)*    | Secret pour les liens de téléchargement |
